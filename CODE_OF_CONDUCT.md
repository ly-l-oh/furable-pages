...
当事件发生时，及时报告非常重要。要报告可能的违规行为，**请发送至[have_dmg@icloud.com](mailto:have_dmg@icloud.com?subject=furable-jb)，加密需求可以[获取PGP公钥](https://keys.openpgp.org/vks/v1/by-fingerprint/7F116B4A164EB0AFD26DC5CB712EED4B4E17433F)（至27/8/2）**。
...
**特殊提醒：以下分级为基本处理机制，管理员也可能酌情采取其它合理可行的处理方式。**
